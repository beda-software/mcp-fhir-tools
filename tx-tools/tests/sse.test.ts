...
// Mocks the terminology server calls made by the tools themselves. Requests the tests make
// against the local test server use the Node global `fetch`, which is untouched by this mock.
